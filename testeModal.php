...
<body>
  ...
  <button type="button" class="btn btn-primary" data-bs-toggle="modal"
    data-bs-target="#ModalCriarMes">Criar Mês Teste</button>
  <!-- Modal Estrutura -->
  <div class="modal fade" id="ModalCriarMes" tabindex="-1"
    aria-labelledby="criarMesLabel" aria-hidden="true">
        ...
        <div class="modal-body">
          <form>
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control" id="monthYear"
                placeholder="Ano">
            </div>
          </form>
        </div>

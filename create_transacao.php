            ...
            <div class="col-sm-7">
                <div class="card shadow rounded">
                    <div class="card-header">
                        <h4>Nova Transação em
                            <?php echo $months[$mesId['name']]; ?>
                        </h4>
                    ...
                    <div class="card-body">
                        ...
                        <form action="acoes.php" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="date" id="txtDataNovaTransacao"
                                    name="txtDataNovaTransacao"
                                    placeholder="aaaa-mm-dd"
                                    class="form-control">
                            </div>
                            <div class="mb-3">
                                <label for="txtTipo">Tipo de
                                    movimentação</label>
                                <select name="txtTipo" id="txtTipo"
                                    class="form-select" aria-label="txtTipo">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="txtCat" class="form-select"
                                    aria-label="txtCat">
                            ...
                            <div class="mb-3">
                                <label
                                    for="txtDescricaoNovaTransacao">Descrição:</label>
                                <textarea name="txtDescricaoNovaTransacao"
                                    id="txtDescricaoNovaTransacao" rows="3"
                                    class="form-control"></textarea>
                            </div>
                            <div class="mb-3">
                                <label
                                    for="txtValorNovaTransacao">Valor:</label>
                                <input type="number" id="txtValorNovaTransacao"
                                    name="txtValorNovaTransacao"
                                    class="form-control">
                            </div>
                            <div class="mb-3">
                                <input type="hidden" name="idMes"
                                    value="<?php echo $_GET['mes_id']; ?>">
                            </div>
                            ...
                            <div class="mb-3">
                                <a href="index.php"
                                    class="btn btn-danger shadow rounded">Voltar</a>
                                <button name="create_transacao" type="submit"
                                    class="btn btn-success float-end shadow rounded"><i
                                        class="bi bi-credit-card-2-back"></i>
                                    Criar</i></button>
                            </div>
                        </form>
                    </div>
